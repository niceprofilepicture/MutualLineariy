...
linearity~\cite{Harunari2024,Khodabandehlou2025,BebonSpeck2026}.
...
\begin{align}
    ...
    \label{eq:finite}
\end{align}
where $G=W^D$ is the Drazin inverse~\cite{Meyer1975}.
